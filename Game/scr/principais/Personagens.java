...
//Construtor de personagem
   ...
   private boolean collisionWithTile(int bx, int i) {
    
     throw new UnsupportedOperationException("Unimplemented method 'collisionWithTile'");
}
...
private void iniciarCombate(int i, int j) {
    
     throw new UnsupportedOperationException("Unimplemented method 'iniciarCombate'");
}*/
